...
class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextRecord() {
            ...
            while (!this.hasNext()) {
                if (!this.rightRecordIterator.hasNext() && !this.leftRecordIterator.hasNext() && !this.rightIterator.hasNext() && !this.leftIterator.hasNext()){
                    throw new NoSuchElementException("No new record to fetch");
                }else if(!this.rightRecordIterator.hasNext() && !this.leftRecordIterator.hasNext() && !this.rightIterator.hasNext() && this.leftIterator.hasNext()){

                    fetchNextLeftBlock();
                    this.rightIterator = BNLJOperator.this.getPageIterator(this.getRightTableName());
                    fetchNextRightPage();
                }else if(!this.rightRecordIterator.hasNext() && !this.leftRecordIterator.hasNext() && this.rightIterator.hasNext()){
                    ...
                    if (leftJoinValue.equals(rightJoinValue)) {
                        this.nextRecord = this.joinRecords(this.leftRecord, rightRecord);
                    }
                }
            }
        }
