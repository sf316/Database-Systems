...
public class Table implements BacktrackingIterable<Record> {
    ...
    //My Code HERE
    //private boolean enableAutoEscalate = true;
    //My Code END
    ...
    public synchronized Record updateRecord(List<DataBox> values, RecordId rid) {
        ...
        //My code HERE
        if(lockContext.enableAutoEscalated){
            enableAutoEscalate();
        }
    ...
    public void enableAutoEscalate() {
        ...
        if (this.lockContext.saturation(TransactionContext.getTransaction()) >= 0.2
                && lockContext.capacity() >= 10){
    ...
    public void disableAutoEscalate() {
        // TODO(proj4_part3): implement
        lockContext.enableAutoEscalated = false;
    }
